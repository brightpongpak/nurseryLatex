...
\afterpage{
  \begin{landscape}
      \begin{figure}
        \includegraphics[width=\linewidth , height=\textheight]{images/databaseDiagram.png}
      \end{figure}
      \label{fig:DatabaseDiagram}
  \end{landscape}
}
    
  ประเภทของฐานข้อมูลที่ใช้เป็นแบบ NOSQL รายละเอียดของ Collection ในฐานข้อมูลของโครงงานนี้ มีดังนี้ รูปที่~\ref{fig:DatabaseDiagram}
  \begin{itemize}
